    ...
    switch (optionSelected) {
        case 1:
            ...
            if (temperatureToConvert < -273.15)
                ...
                console.log("".concat(temperatureToConvert, " Celsius grades is equivalent to ").concat(convertedTemperature, " Kelvin grades"));
            }
            break;
        case 2:
            ...
            if (temperatureToConvert < 0)
                ...
                convertedTemperature = temperatureToConvert - 273.15;
                console.log("The temperature has been converted");
                console.log("".concat(temperatureToConvert, " Kelvin grades is equivalent to ").concat(convertedTemperature, " Celsius grades"));
            }
            break;
        case 3:
            console.log("Exiting.");
